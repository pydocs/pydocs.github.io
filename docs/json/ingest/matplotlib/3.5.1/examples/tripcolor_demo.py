...
Ù±‚`ctpcÙ±‚`a Ù±‚aoa=Ù±‚`a Ù±‚`cax1Ù±‚aoa.Ù±‚`itripcolorÙ±‚`a(Ù±‚`ftriangÙ±‚`a,Ù±‚`a Ù±‚`azÙ±‚`a,Ù±‚`a Ù±‚`gshadingÙ±‚aoa=Ù±‚bs1a'Ù±‚bs1dflatÙ±‚bs1a'Ù±‚`a)Ù±‚`a
Ù±‚`dfig1Ù±‚aoa.Ù±‚`hcolorbarÙ±‚`a(Ù±‚`ctpcÙ±‚`a)Ù±‚`a
Ù±‚`cax1Ù±‚aoa.Ù±‚`iset_titleÙ±‚`a(Ù±‚bs1a'Ù±‚bs1x1tripcolor of Delaunay triangulation, flat shadingÙ±‚bs1a'Ù±‚`a)Ù±‚`a
Ù±‚`a
Ù±‚bc1xO###############################################################################Ù±‚`a
Ù±‚bc1x# Illustrate Gouraud shading.Ù±‚`a
Ù±‚`a
...
Ù±‚`ctpcÙ±‚`a Ù±‚aoa=Ù±‚`a Ù±‚`cax2Ù±‚aoa.Ù±‚`itripcolorÙ±‚`a(Ù±‚`ftriangÙ±‚`a,Ù±‚`a Ù±‚`azÙ±‚`a,Ù±‚`a Ù±‚`gshadingÙ±‚aoa=Ù±‚bs1a'Ù±‚bs1ggouraudÙ±‚bs1a'Ù±‚`a)Ù±‚`a
Ù±‚`dfig2Ù±‚aoa.Ù±‚`hcolorbarÙ±‚`a(Ù±‚`ctpcÙ±‚`a)Ù±‚`a
Ù±‚`cax2Ù±‚aoa.Ù±‚`iset_titleÙ±‚`a(Ù±‚bs1a'Ù±‚bs1x4tripcolor of Delaunay triangulation, gouraud shadingÙ±‚bs1a'Ù±‚`a)Ù±‚`a
Ù±‚`a
Ù±‚`a
Ù±‚bc1xO###############################################################################Ù±‚`a
...
Ù±‚`axÙ±‚`a,Ù±‚`a Ù±‚`ayÙ±‚`a Ù±‚aoa=Ù±‚`a Ù±‚`bnpÙ±‚aoa.Ù±‚`grad2degÙ±‚`a(Ù±‚`bxyÙ±‚`a)Ù±‚aoa.Ù±‚`aTÙ±‚`a
Ù±‚`a
...
Ù±‚`a
Ù±‚`dxmidÙ±‚`a Ù±‚aoa=Ù±‚`a Ù±‚`axÙ±‚`a[Ù±‚`itrianglesÙ±‚`a]Ù±‚aoa.Ù±‚`dmeanÙ±‚`a(Ù±‚`daxisÙ±‚aoa=Ù±‚bmia1Ù±‚`a)Ù±‚`a
Ù±‚`dymidÙ±‚`a Ù±‚aoa=Ù±‚`a Ù±‚`ayÙ±‚`a[Ù±‚`itrianglesÙ±‚`a]Ù±‚aoa.Ù±‚`dmeanÙ±‚`a(Ù±‚`daxisÙ±‚aoa=Ù±‚bmia1Ù±‚`a)Ù±‚`a
Ù±‚`bx0Ù±‚`a Ù±‚aoa=Ù±‚`a Ù±‚aoa-Ù±‚bmia5Ù±‚`a
Ù±‚`by0Ù±‚`a Ù±‚aoa=Ù±‚`a Ù±‚bmib52Ù±‚`a
Ù±‚`fzfacesÙ±‚`a Ù±‚aoa=Ù±‚`a Ù±‚`bnpÙ±‚aoa.Ù±‚`cexpÙ±‚`a(Ù±‚aoa-Ù±‚bmfd0.01Ù±‚`a Ù±‚aoa*Ù±‚`a Ù±‚`a(Ù±‚`a(Ù±‚`dxmidÙ±‚`a Ù±‚aoa-Ù±‚`a Ù±‚`bx0Ù±‚`a)Ù±‚`a Ù±‚aoa*Ù±‚`a Ù±‚`a(Ù±‚`dxmidÙ±‚`a Ù±‚aoa-Ù±‚`a Ù±‚`bx0Ù±‚`a)Ù±‚`a Ù±‚aoa+Ù±‚`a
Ù±‚`x                         Ù±‚`a(Ù±‚`dymidÙ±‚`a Ù±‚aoa-Ù±‚`a Ù±‚`by0Ù±‚`a)Ù±‚`a Ù±‚aoa*Ù±‚`a Ù±‚`a(Ù±‚`dymidÙ±‚`a Ù±‚aoa-Ù±‚`a Ù±‚`by0Ù±‚`a)Ù±‚`a)Ù±‚`a)Ù±‚`a
Ù±‚`a
Ù±‚bc1xO###############################################################################Ù±‚`a
...
Ù±‚bc1xM# Can specify one color value per face rather than one per point by using theÙ±‚`a
Ù±‚bc1x # *facecolors* keyword argument.Ù±‚`a
Ù±‚`a
Ù±‚`dfig3Ù±‚`a,Ù±‚`a Ù±‚`cax3Ù±‚`a Ù±‚aoa=Ù±‚`a Ù±‚`cpltÙ±‚aoa.Ù±‚`hsubplotsÙ±‚`a(Ù±‚`a)Ù±‚`a
Ù±‚`cax3Ù±‚aoa.Ù±‚`jset_aspectÙ±‚`a(Ù±‚bs1a'Ù±‚bs1eequalÙ±‚bs1a'Ù±‚`a)Ù±‚`a
Ù±‚`ctpcÙ±‚`a Ù±‚aoa=Ù±‚`a Ù±‚`cax3Ù±‚aoa.Ù±‚`itripcolorÙ±‚`a(Ù±‚`axÙ±‚`a,Ù±‚`a Ù±‚`ayÙ±‚`a,Ù±‚`a Ù±‚`itrianglesÙ±‚`a,Ù±‚`a Ù±‚`jfacecolorsÙ±‚aoa=Ù±‚`fzfacesÙ±‚`a,Ù±‚`a Ù±‚`jedgecolorsÙ±‚aoa=Ù±‚bs1a'Ù±‚bs1akÙ±‚bs1a'Ù±‚`a)Ù±‚`a
Ù±‚`dfig3Ù±‚aoa.Ù±‚`hcolorbarÙ±‚`a(Ù±‚`ctpcÙ±‚`a)Ù±‚`a
Ù±‚`cax3Ù±‚aoa.Ù±‚`iset_titleÙ±‚`a(Ù±‚bs1a'Ù±‚bs1x)tripcolor of user-specified triangulationÙ±‚bs1a'Ù±‚`a)Ù±‚`a
Ù±‚`cax3Ù±‚aoa.Ù±‚`jset_xlabelÙ±‚`a(Ù±‚bs1a'Ù±‚bs1sLongitude (degrees)Ù±‚bs1a'Ù±‚`a)Ù±‚`a
Ù±‚`cax3Ù±‚aoa.Ù±‚`jset_ylabelÙ±‚`a(Ù±‚bs1a'Ù±‚bs1rLatitude (degrees)Ù±‚bs1a'Ù±‚`a)Ù±‚`a
Ù±‚`a
...
Ù±‚bc1a#Ù±‚`a
Ù±‚bc1xG#    - `matplotlib.axes.Axes.tripcolor` / `matplotlib.pyplot.tripcolor`Ù±‚`a
