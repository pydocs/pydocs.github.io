...
Ù±‚`caxsÙ±‚`a[Ù±‚bmia0Ù±‚`a,Ù±‚`a Ù±‚bmia0Ù±‚`a]Ù±‚aoa.Ù±‚`gboxplotÙ±‚`a(Ù±‚`ddataÙ±‚`a,Ù±‚`a Ù±‚`flabelsÙ±‚aoa=Ù±‚`flabelsÙ±‚`a)Ù±‚`a
...
Ù±‚`a
Ù±‚`caxsÙ±‚`a[Ù±‚bmia0Ù±‚`a,Ù±‚`a Ù±‚bmia1Ù±‚`a]Ù±‚aoa.Ù±‚`gboxplotÙ±‚`a(Ù±‚`ddataÙ±‚`a,Ù±‚`a Ù±‚`flabelsÙ±‚aoa=Ù±‚`flabelsÙ±‚`a,Ù±‚`a Ù±‚`ishowmeansÙ±‚aoa=Ù±‚bkcdTrueÙ±‚`a)Ù±‚`a
...
Ù±‚`a
Ù±‚`caxsÙ±‚`a[Ù±‚bmia0Ù±‚`a,Ù±‚`a Ù±‚bmia2Ù±‚`a]Ù±‚aoa.Ù±‚`gboxplotÙ±‚`a(Ù±‚`ddataÙ±‚`a,Ù±‚`a Ù±‚`flabelsÙ±‚aoa=Ù±‚`flabelsÙ±‚`a,Ù±‚`a Ù±‚`ishowmeansÙ±‚aoa=Ù±‚bkcdTrueÙ±‚`a,Ù±‚`a Ù±‚`hmeanlineÙ±‚aoa=Ù±‚bkcdTrueÙ±‚`a)Ù±‚`a
...
Ù±‚`a
Ù±‚`caxsÙ±‚`a[Ù±‚bmia1Ù±‚`a,Ù±‚`a Ù±‚bmia0Ù±‚`a]Ù±‚aoa.Ù±‚`gboxplotÙ±‚`a(Ù±‚`ddataÙ±‚`a,Ù±‚`a Ù±‚`flabelsÙ±‚aoa=Ù±‚`flabelsÙ±‚`a,Ù±‚`a Ù±‚`gshowboxÙ±‚aoa=Ù±‚bkceFalseÙ±‚`a,Ù±‚`a Ù±‚`hshowcapsÙ±‚aoa=Ù±‚bkceFalseÙ±‚`a)Ù±‚`a
Ù±‚`ktufte_titleÙ±‚`a Ù±‚aoa=Ù±‚`a Ù±‚bs1a'Ù±‚bs1lTufte Style Ù±‚bseb\nÙ±‚bs1o(showbox=False,Ù±‚bseb\nÙ±‚bs1oshowcaps=False)Ù±‚bs1a'Ù±‚`a
Ù±‚`caxsÙ±‚`a[Ù±‚bmia1Ù±‚`a,Ù±‚`a Ù±‚bmia0Ù±‚`a]Ù±‚aoa.Ù±‚`iset_titleÙ±‚`a(Ù±‚`ktufte_titleÙ±‚`a,Ù±‚`a Ù±‚`hfontsizeÙ±‚aoa=Ù±‚`bfsÙ±‚`a)Ù±‚`a
Ù±‚`a
Ù±‚`caxsÙ±‚`a[Ù±‚bmia1Ù±‚`a,Ù±‚`a Ù±‚bmia1Ù±‚`a]Ù±‚aoa.Ù±‚`gboxplotÙ±‚`a(Ù±‚`ddataÙ±‚`a,Ù±‚`a Ù±‚`flabelsÙ±‚aoa=Ù±‚`flabelsÙ±‚`a,Ù±‚`a Ù±‚`enotchÙ±‚aoa=Ù±‚bkcdTrueÙ±‚`a,Ù±‚`a Ù±‚`ibootstrapÙ±‚aoa=Ù±‚bmie10000Ù±‚`a)Ù±‚`a
Ù±‚`caxsÙ±‚`a[Ù±‚bmia1Ù±‚`a,Ù±‚`a Ù±‚bmia1Ù±‚`a]Ù±‚aoa.Ù±‚`iset_titleÙ±‚`a(Ù±‚bs1a'Ù±‚bs1knotch=True,Ù±‚bseb\nÙ±‚bs1obootstrap=10000Ù±‚bs1a'Ù±‚`a,Ù±‚`a Ù±‚`hfontsizeÙ±‚aoa=Ù±‚`bfsÙ±‚`a)Ù±‚`a
Ù±‚`a
Ù±‚`caxsÙ±‚`a[Ù±‚bmia1Ù±‚`a,Ù±‚`a Ù±‚bmia2Ù±‚`a]Ù±‚aoa.Ù±‚`gboxplotÙ±‚`a(Ù±‚`ddataÙ±‚`a,Ù±‚`a Ù±‚`flabelsÙ±‚aoa=Ù±‚`flabelsÙ±‚`a,Ù±‚`a Ù±‚`jshowfliersÙ±‚aoa=Ù±‚bkceFalseÙ±‚`a)Ù±‚`a
...
Ù±‚`r                  Ù±‚`omarkeredgecolorÙ±‚aoa=Ù±‚bs1a'Ù±‚bs1dnoneÙ±‚bs1a'Ù±‚`a)Ù±‚`a
...
Ù±‚`a
Ù±‚`cfigÙ±‚`a,Ù±‚`a Ù±‚`caxsÙ±‚`a Ù±‚aoa=Ù±‚`a Ù±‚`cpltÙ±‚aoa.Ù±‚`hsubplotsÙ±‚`a(Ù±‚`enrowsÙ±‚aoa=Ù±‚bmia2Ù±‚`a,Ù±‚`a Ù±‚`encolsÙ±‚aoa=Ù±‚bmia3Ù±‚`a,Ù±‚`a Ù±‚`gfigsizeÙ±‚aoa=Ù±‚`a(Ù±‚bmia6Ù±‚`a,Ù±‚`a Ù±‚bmia6Ù±‚`a)Ù±‚`a,Ù±‚`a Ù±‚`fshareyÙ±‚aoa=Ù±‚bkcdTrueÙ±‚`a)Ù±‚`a
Ù±‚`caxsÙ±‚`a[Ù±‚bmia0Ù±‚`a,Ù±‚`a Ù±‚bmia0Ù±‚`a]Ù±‚aoa.Ù±‚`gboxplotÙ±‚`a(Ù±‚`ddataÙ±‚`a,Ù±‚`a Ù±‚`hboxpropsÙ±‚aoa=Ù±‚`hboxpropsÙ±‚`a)Ù±‚`a
...
Ù±‚`a
Ù±‚`caxsÙ±‚`a[Ù±‚bmia0Ù±‚`a,Ù±‚`a Ù±‚bmia1Ù±‚`a]Ù±‚aoa.Ù±‚`gboxplotÙ±‚`a(Ù±‚`ddataÙ±‚`a,Ù±‚`a Ù±‚`jflierpropsÙ±‚aoa=Ù±‚`jflierpropsÙ±‚`a,Ù±‚`a Ù±‚`kmedianpropsÙ±‚aoa=Ù±‚`kmedianpropsÙ±‚`a)Ù±‚`a
...
Ù±‚`a
Ù±‚`caxsÙ±‚`a[Ù±‚bmia0Ù±‚`a,Ù±‚`a Ù±‚bmia2Ù±‚`a]Ù±‚aoa.Ù±‚`gboxplotÙ±‚`a(Ù±‚`ddataÙ±‚`a,Ù±‚`a Ù±‚`dwhisÙ±‚aoa=Ù±‚`a(Ù±‚bmia0Ù±‚`a,Ù±‚`a Ù±‚bmic100Ù±‚`a)Ù±‚`a)Ù±‚`a
Ù±‚`caxsÙ±‚`a[Ù±‚bmia0Ù±‚`a,Ù±‚`a Ù±‚bmia2Ù±‚`a]Ù±‚aoa.Ù±‚`iset_titleÙ±‚`a(Ù±‚bs1a'Ù±‚bs1mwhis=(0, 100)Ù±‚bs1a'Ù±‚`a,Ù±‚`a Ù±‚`hfontsizeÙ±‚aoa=Ù±‚`bfsÙ±‚`a)Ù±‚`a
Ù±‚`a
Ù±‚`caxsÙ±‚`a[Ù±‚bmia1Ù±‚`a,Ù±‚`a Ù±‚bmia0Ù±‚`a]Ù±‚aoa.Ù±‚`gboxplotÙ±‚`a(Ù±‚`ddataÙ±‚`a,Ù±‚`a Ù±‚`imeanpropsÙ±‚aoa=Ù±‚`nmeanpointpropsÙ±‚`a,Ù±‚`a Ù±‚`hmeanlineÙ±‚aoa=Ù±‚bkceFalseÙ±‚`a,Ù±‚`a
Ù±‚`r                  Ù±‚`ishowmeansÙ±‚aoa=Ù±‚bkcdTrueÙ±‚`a)Ù±‚`a
...
Ù±‚`a
Ù±‚`caxsÙ±‚`a[Ù±‚bmia1Ù±‚`a,Ù±‚`a Ù±‚bmia1Ù±‚`a]Ù±‚aoa.Ù±‚`gboxplotÙ±‚`a(Ù±‚`ddataÙ±‚`a,Ù±‚`a Ù±‚`imeanpropsÙ±‚aoa=Ù±‚`mmeanlinepropsÙ±‚`a,Ù±‚`a Ù±‚`hmeanlineÙ±‚aoa=Ù±‚bkcdTrueÙ±‚`a,Ù±‚`a
Ù±‚`r                  Ù±‚`ishowmeansÙ±‚aoa=Ù±‚bkcdTrueÙ±‚`a)Ù±‚`a
...
Ù±‚`a
Ù±‚`caxsÙ±‚`a[Ù±‚bmia1Ù±‚`a,Ù±‚`a Ù±‚bmia2Ù±‚`a]Ù±‚aoa.Ù±‚`gboxplotÙ±‚`a(Ù±‚`ddataÙ±‚`a,Ù±‚`a Ù±‚`dwhisÙ±‚aoa=Ù±‚`a[Ù±‚bmib15Ù±‚`a,Ù±‚`a Ù±‚bmib85Ù±‚`a]Ù±‚`a)Ù±‚`a
Ù±‚`caxsÙ±‚`a[Ù±‚bmia1Ù±‚`a,Ù±‚`a Ù±‚bmia2Ù±‚`a]Ù±‚aoa.Ù±‚`iset_titleÙ±‚`a(Ù±‚bs1a'Ù±‚bs1mwhis=[15, 85]Ù±‚bseb\nÙ±‚bs1l#percentilesÙ±‚bs1a'Ù±‚`a,Ù±‚`a Ù±‚`hfontsizeÙ±‚aoa=Ù±‚`bfsÙ±‚`a)Ù±‚`a
Ù±‚`a
Ù±‚akcforÙ±‚`a Ù±‚`baxÙ±‚`a Ù±‚bowbinÙ±‚`a Ù±‚`caxsÙ±‚aoa.Ù±‚`dflatÙ±‚`a:Ù±‚`a
Ù±‚`d    Ù±‚`baxÙ±‚aoa.Ù±‚`jset_yscaleÙ±‚`a(Ù±‚bs1a'Ù±‚bs1clogÙ±‚bs1a'Ù±‚`a)Ù±‚`a
Ù±‚`d    Ù±‚`baxÙ±‚aoa.Ù±‚`oset_yticklabelsÙ±‚`a(Ù±‚`a[Ù±‚`a]Ù±‚`a)Ù±‚`a
