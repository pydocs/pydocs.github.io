{
  ...
  "see_also": [
    {
      "name": {
        "name": "psd",
        "ref": "matplotlib.axes._axes.Axes.psd",
        "exists": true
      },
      "descriptions": [
        {
  ...
  "version": "3.5.1",
  "signature": "csd(self, x, y, NFFT=None, Fs=None, Fc=None, detrend=None, window=None, noverlap=None, pad_to=None, sides=None, scale_by_freq=None, return_line=None, *, data=None, **kwargs)",
  "references": null,
  "logo": "logo.png",
  "qa": "matplotlib.axes._axes.Axes.csd",
  "arbitrary": []
}